"""
Why Object OR Why Object Oriented Programming

In this section, we should get 100% clarity on
1) Encapsulation: Keeping data and related methods together
2) Abstraction: We just need to know how to use methods, NO need to know how methods are implemented
"""

print("DATA inside 'str' class object")
print("-"*20)
# -------------------
